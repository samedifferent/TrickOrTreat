...
public class ModItems {
    ...
    public static final RegistryObject<CandyItem> BONEBREAKER = ITEMS.register("bonebreaker", () -> new CandyItem(new Item.Properties().rarity(Rarity.EPIC).stacksTo(16).tab(TrickOrTreat.TAB).food(new FoodProperties.Builder().fast().alwaysEat().effect(() -> new MobEffectInstance(ModEffects.BONE_BREAKING.get(), 200), 1).build())));
